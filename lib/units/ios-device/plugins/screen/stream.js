...
module.exports = syrup.serial()
  ...
  .define(function(options, display, group, screenOptions) {
    ...
    FrameProducer.prototype.start = function() {
      log.info('Requesting frame producer to start ios')
      console.log('这是连接上ios服务');
      console.log(options);
      group.getEmail().then(resp=>{
        console.log("链接 ios 返回数据");
        this.sendEmail = resp;
        console.log(resp);
      })
